...
<nav class="navbar navbar-expand-lg  position-fixed w-100">
    <div class="container-fluid">
        <a class="navbar-brand" href="../pressing/index.php">Mon Pressing de ouf</a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../pressing/index.php">Home</a>
                </li>
            ...
            <ul class="navbar-nav align-items-center">
                <li class="nav-item text-lg-center text-start">
                    ...
                    if($is_admin) {
                        echo ('<svg width="46" height="46" fill="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg><a class="nav-link" href="../pressing/admin.php">Mon compte</a>');
                    }else {
                        echo ('<svg width="46" height="46" fill="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg><a class="nav-link" href="../pressing/connection.php">Me connecter</a>');
                    }
                    ?>
                </li>
                ...
                <li class="nav-item ms-5">
                    <?php
                    if($is_admin){
                        echo ('<a class="text-decoration-none d-flex flex-column" href="../pressing/panier.php"> <svg width="46" height="46" fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
